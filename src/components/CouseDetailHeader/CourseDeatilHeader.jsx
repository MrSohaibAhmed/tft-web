        ...
        <div className="flex  min-h-[110vh] items-center flex-col lg:flex-row">
          ...
          <div className="right flex relative justify-center items-center w-[100vw] lg:w-[40vw]">
            <div className="card z-10 relative h-[110vh] w-[100%] md:pt-0 md:w-[70%] lg:w-[80%] rounded-bl-lg rounded-br-lg bg-custom-gradient">
              <img src="/public/--1-1@2x.png" className="absolute right-[-20px] top-[20px] w-[63px] h-[61px]"  alt="" />
              <img src="/public/--1-3@2x.png" className="absolute right-[-20px] top-[160px] w-[113px] h-[111px]"  alt="" />
              <img src="/public/--1-2@2x.png" className="absolute left-[-20px] top-[80px] w-[89px] h-[87px]"  alt="" />
              
              <div className="top h-[30%] flex justify-center items-center relative bottom-[-80px] ">
                <img src="/public/Rectangle 15.png" className="rounded-[50%]" alt="" />
              </div>
              <div className="bottom h-[70%] p-8 flex flex-col justify-center items-center lg:items-start bg-white">
                ...
                <h1 className=" font-semibold text-[45px] text-[#350C50] ">Salaar Haris</h1>
                <h1 className=" font-bold text-gray-300">Description</h1>
                <p className="text-[#350C50] font-medium text-wrap">
                  This Course is Design for all type of Designing Modules. This Course is Design for all type of Designing Modules. This Course is Design for all type of Designing Modules. This Course is Design for all type of Designing Modules.
                </p>
                <button
                  className="mt-[60px] self-center bg-custom-gradient font-bold pt-[10px] pb-[10px] pl-[25px] w-[272px] h-[56px] pr-[25px] rounded-md text-white">Register</button>
              </div>
             
            </div> 
            <img src="/public/--1-4@2x.png" className="absolute left-[-90px] bottom-[280px] w-[130px] h-[135px]" alt="" />
            <img src="/public/--1-1@2x.png" className="absolute right-[20px] bottom-[80px] w-[130px] h-[135px]" alt="" />
            <div className=" h-[100vh] w-[30%] lg:w-[20%] hidden md:block bg-white rounded-tl-full rounded-bl-full rounded">
